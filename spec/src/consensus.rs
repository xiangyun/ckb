...
use ckb_types::{
    ...
    core::{
        hardforks::HardForkSwitch, BlockBuilder, BlockNumber, BlockView, Capacity, Cycle, EpochExt,
    ...
    pub fn new(genesis_block: BlockView, genesis_epoch_ext: EpochExt) -> Self {
        ...
        ConsensusBuilder {
            inner: Consensus {
                ...
                hardfork_switch: HardForkSwitch::always_no_fork(),
            },
        }
    }
...
impl Consensus {
    ...
    /// Returns a switch to select hard fork version base on the block number.
